...
// const halfpipe = new THREE.CylinderGeometry( 50, 50, 100, 20, 1, true, 0, 1.5);
//
// var material = new THREE.MeshNormalMaterial( { color: 0x212121, side: THREE.DoubleSide } );
//
...
// });
//
// const halfpipemesh = new THREE.Mesh(
//     halfpipe,
//     doormaterial
// );
//
// scene.add(halfpipemesh);
